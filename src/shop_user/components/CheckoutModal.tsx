          ...
          {step === "summary" && (
            <>
              ...
              <button
                ...
                style={{ width: "100%", marginTop: 16, padding: "13px", background: theme.primary, color: "#fff", border: "none", borderRadius: theme.radius, fontWeight: 800, fontSize: 15, cursor: "pointer" }}
              >
                Continue to Payment →
              </button>
            </>
            ...
            <>
              ...
              {PAYMENT_METHODS.map(m => (
                ...
                >
                  ...
                  {payMethod === m.id && <span style={{ marginLeft: "auto", color: theme.primary, fontWeight: 900, fontSize: 20 }}>✓</span>}
                </div>
              ))}
              <div style={{ marginTop: 16, display: "flex", gap: 10 }}>
                <button
                  onClick={() => setStep("summary")}
                  style={{ flex: 1, padding: "12px", background: "none", border: `1.5px solid ${theme.border}`, borderRadius: theme.radius, fontWeight: 700, color: theme.black, cursor: "pointer" }}
                >
                  ← Back
                </button>
                <button
